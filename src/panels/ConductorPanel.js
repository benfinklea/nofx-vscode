...
class ConductorPanel {
    constructor(webviewHost, context, viewModel, loggingService) {
        ...
        this.panelBinder.bindWebviewToViewModel(this.webviewHost, this.viewModel, (state, webviewHost) => this.template.generateConductorHTML(state, webviewHost), {
            onDispose: () => {
                this.disposed = true;
...
exports.ConductorPanel = ConductorPanel;
//# sourceMappingURL=ConductorPanel.js.map