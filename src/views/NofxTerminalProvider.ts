...
export class NofxTerminalProvider implements vscode.WebviewViewProvider {
    public static readonly viewType = 'nofx.terminalView';
    ...
    private focusAgentTerminal(agentId: string) {
